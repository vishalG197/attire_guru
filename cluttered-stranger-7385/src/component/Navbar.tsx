	...
	return <header>
		...
		<div className={"secNav"} >
			...
			<nav className={navClass ? "responsive_nav" : "false"} >
				...
				<Link to="/product" className="about section" >MEN</Link>
				<div className="blackDot"></div>
						...
						{({ isOpen }) => (
							<div>
								...
								<MenuList style={{ display: "flex", flexDirection: "column" }}>
									<MenuItem color={"black"} onClick={() => navgite("/profile")}>Profile</MenuItem>
									<MenuItem color={"black"} onClick={() => navgite("/my-orders")}>My Orders</MenuItem>
									<MenuDivider />
